            ...
            <div className="glass-hero p-8 md:p-12 rounded-[3rem] shadow-2xl">
              ...
              <div className="text-center mb-8">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                  <span className="font-elegant gradient-text-primary">Connexion</span>
                </h1>
                <p className="mt-3 text-muted-foreground text-base">
                  Connectez-vous à votre compte Entraidance
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-center text-sm text-muted-foreground pt-4">
                  ...
                  <Link href="/register" className="text-[#9333ea] font-semibold hover:underline">
                    Inscription
                  </Link>
                </p>
              </form>
